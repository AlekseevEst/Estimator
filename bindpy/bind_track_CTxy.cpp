...
// {
// private:
//     Track<Eigen::MatrixXd, UnscentedKalmanfilter<Eigen::MatrixXd, FuncConstTurnXY, FuncMeasSphCVCT, FuncControlMatrix_XvXYvYZvZW>,
//           InitUKFStateModelCTMeasureModelSph<Eigen::MatrixXd, FuncConstTurnXY,
//                                              FuncMeasSphCVCT, FuncControlMatrix_XvXYvYZvZW>>
//         track;

// public:

//     BindTrackUkf_CTxy(const Detection<Eigen::MatrixXd>& detection):track(detection){}
